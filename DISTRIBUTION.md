...
## Release baseline — 2026-09-15

Phaenix 12.5.0 and Altair 4.7.0 are released. Public discovery confirmed Altair 4.7.0 with the renamed innovation tools and four prompts. Both plugin packages are version 1.1.0 and contain identical skills trees. Package builds and manifest validation passed; host installation and authenticated production acceptance cases remain separate checks. See the [connector release guide](https://github.com/lightbringer-patents/mcp-connector/blob/main/RELEASE.md) for the coordinated repository and registry release steps.
